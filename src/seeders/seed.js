...
async function seed() {
  try {
    ...
    // Groups
    const grp1 = await Group.create({ name:'Kampala Teachers SACCO', slug:'kampala-teachers', accentColor:'#90E0EF', adminEmail:'admin@kteachers.coop', accountNumber:'0012345678901', bankName:'Stanbic Bank Uganda', active:true });
